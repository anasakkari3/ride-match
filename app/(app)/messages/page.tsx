...
export default async function MessagesPage() {
    ...
    return (
        <div className="p-4 max-w-lg mx-auto space-y-4 pb-24">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight">Messages</h1>
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-xl overflow-hidden">
                                    {thread.lastMessage?.sender?.avatar_url ? (
                                        <img src={thread.lastMessage.sender.avatar_url} alt="avatar" className="w-full h-full object-cover" />
                                    ) : (
                                        <span>💬</span>
                                    )}
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm font-medium text-sky-600 dark:text-sky-400 mb-1 line-clamp-1">
                                        {thread.conversationWith}
                                    </p>
